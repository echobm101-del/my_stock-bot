...
# --- [1. UI 스타일링] ---
st.set_page_config(page_title="Quant Sniper V22.2", page_icon="💎", layout="wide")
...
def get_news_sentiment(company_name):
    try:
        ...
        # [V22.2 수정] URL을 안전하게 조립 (SyntaxError 방지)
        ...
        return {"score": 0, "headline": f"시스템 오류: {str(e)}", "raw_news": [], "method": "error"}
