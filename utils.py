...
def get_ai_summary(name, price, change_rate, rsi, trend):
    ...
    try:
        ...
        [조건]
        1. 첫 줄: 현재 상황을 한 문장으로 요약.
        2. 둘째 줄: 기술적 지표(RSI 등)를 기반으로 평가.
        3. 셋째 줄: '매수', '매도', '관망' 중 하나의 의견을 명확히 제시.
        4. 말투: 간결하고 명확하게. (3줄 이내)
        """
        
        # 모델명을 최신 버전인 'gemini-1.5-flash'로 변경!
...
def analyze_basic(input_val, name_override=None, my_buy_price=0):
    ...
    try:
        ...
        return {
            ...
            "trend_txt": trend_txt,
            "news": {
                "headline": "Gemini 1.5 Flash 분석", 
                "opinion": ai_comment,
                "risk": "투자 책임은 본인에게 있습니다."
            },
